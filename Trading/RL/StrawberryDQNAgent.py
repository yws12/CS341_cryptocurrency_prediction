'''
Strawberry
1. Change NN structure:
    1) use 2 layer LSTM to encode external states of previous seq_len hours
    2) fully connected layer1
    2) concatenate with current internal states 
    3) fully connected layer2 
2. Use super slow eplison decay to allow more randomness 
