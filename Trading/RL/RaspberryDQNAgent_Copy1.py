'''
Raspberry_copy1
1. Changed epsilon_min = 0.005
2. In test(), force epsilon to be 0.0001 (some formatting problem if I use 0)
3. In train(), require a new argument 'reward_func' which is used in __replay()
4. Memory is changed back to a long list with max len 100000
